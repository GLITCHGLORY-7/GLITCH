...
![AskBase Logo](snapshots/logo.jpg)
...
- **Table Targeting (`@` Command):** By typing `@` followed by a table name (e.g., `@sales` or `@customers`), users can force the AI to strictly search within those specific database tables, guaranteeing 100% precision and eliminating hallucination.
- **Slash Commands (`\` Command):** Instantly trigger system actions without complex prompting. 
  - `\report`: Instantly convert the current chat context into an Executive PDF report.
  - `\schema`: Open the dynamic database schema inspector.
  - `\clear`: Safely wipe the current context window.

---

## 4. SCREENSHOTS & INTERFACE GALLERY

Below is the complete visual walkthrough of the AskBase interface, detailing every component, feature, and capability.

### 1. Onboarding & Authentication
**Account & Authentication**
![Account Creation](snapshots/signup.jpg)
*Secure, role-based onboarding ensuring strict tenant isolation and enterprise-grade data safety.*

**Team & Credential Management**
![Account Management](snapshots/account.jpg)
*Seamless account switching and team management accessible from the main dashboard.*

### 2. The Core Platform & Agent Experience
**The Command Dashboard**
![Dashboard](snapshots/feature_01.jpg)
*Instant visibility into your FastAPI subsystem, database connections, and RAG document indexing health.*

**Conversational Interface with SQL Transparency**
![Chat](snapshots/feature_02.jpg)
*A rendered table with export actions, a collapsible Query Used panel, and a plain-language summary underneath.*

**Power-User Slash Commands (`\`)**
![Slash Commands](snapshots/feature_03.jpg)
*Type `/` to invoke system actions instantly: `/report` (Executive PDFs), `/schema` (Schema Inspector), `/clear`, and `/help`.*

**Precision Database Tags (`@`)**
![Table Tags](snapshots/feature_04.jpg)
*Type `@` to tag tables. Tell the AI exactly where to look (`@sales`, `@orders`) for unmatched SQL accuracy.*

**Corporate Knowledge Base (RAG)**
![Knowledge Base](snapshots/feature_05.jpg)
*Upload PDFs, CSVs, or JSONs. The system chunks and vector-indexes them. The green "RAG Indexed" badge guarantees secure answers.*
...
*Total transparency. Visualize every table, column, data type, and relationship mapped dynamically.*

**Multi-Format Analytics**
![Analytics](snapshots/feature_08.jpg) 
*Toggle dynamically between Bar, Line, Area, and Pie charts with automated custom palettes.*

**Hands-Free Voice AI Agent**
![Voice Mic](snapshots/feature_09.jpg)
*Speak your query, and the AI will listen, analyze, chart it, and speak the insights back to you.*

**Data Grid & Table Views**
![Feature 10](snapshots/feature_10.jpg)
*Interactive tables with pagination, sorting, and inline editing options.*

**Global Analytics & Localization**
![Currency Selection](snapshots/currency.jpg)
*Dynamic localization allowing users to configure 35 global reporting currencies (e.g., Indian Rupee `₹`) directly in the interface. (Also shown in [feature_11.jpg](snapshots/feature_11.jpg))*

### 4. Reporting, Workspaces & Export
**Professional Executive Reports**
![Reports](snapshots/feature_12.jpg)
*Generate full-bleed, professional Executive PDF Documents—complete with summaries and charts—ready for the boardroom.*

**Multi-Project Workspaces**
![Workspaces](snapshots/feature_13.jpg)
*Create separate workspaces (e.g., HR, Sales, Marketing) mapped to entirely different databases.*

**Automated AI Insights**
![Feature 14](snapshots/feature_14.jpg)
*Contextual analysis highlighting anomalies, trends, and key performance indicators.*

**Universal Export (CSV, Excel, JSON)**
![Export](snapshots/feature_15.jpg) 
*Export any query result natively to CSV, Excel, or JSON for seamless integration.*

### 5. Extended Capabilities
**Advanced Charting Options**
![Feature 16](snapshots/feature_16.jpg)
*Deep-dive analytics tools and layout configurations.*

**Executive Dashboard Builder**
![Feature 17](snapshots/feature_17.jpg)
*Drag-and-drop widget arrangement for custom KPI tracking.*

**Data Source Connectivity**
![Feature 18](snapshots/feature_18.jpg)
*Connect multiple PostgreSQL, SQLite, or file-based data sources seamlessly.*

**Lineage Tracking**
![Feature 19](snapshots/feature_19.jpg)
*Trace back any generated chart to the exact SQL query and source table.*

**Query History & Favorites**
![Feature 20](snapshots/feature_20.jpg)
*Save complex queries for single-click re-execution later.*

**Dynamic Data Rendering**
![Feature 21](snapshots/feature_21.jpg)
*The platform automatically selects the best visualization type for the requested data.*

**Report Generation Settings**
![Feature 22](snapshots/feature_22.jpg)
*Configure PDF layouts, headers, footers, and brand colors.*

**System Logs & Health**
![Feature 23](snapshots/feature_23.jpg)
*Monitor API latency, LLM token usage, and database connection status.*

**Pie Chart Deep-Dive**
![Pie Chart](snapshots/feature_24.jpg)
*Beautiful, accessible pie charts with interactive hover states.*

**User Preferences**
![Feature 26](snapshots/feature_26.jpg)
*Manage individual display settings and API configurations.*

**Data Processing Status**
![Feature 27](snapshots/feature_27.jpg)
*Live feedback during long-running data indexing and analysis tasks.*
