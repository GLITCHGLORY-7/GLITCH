...
![Account Creation](snapshots/signup.jpg)
*Every journey begins with secure, role-based onboarding. AskBase ensures strict tenant isolation so your enterprise data remains completely siloed and safe.*

**Team & Credential Management**
![Account Management](snapshots/account.jpg)
*A dedicated management modal allowing administrators to switch accounts, manage credentials, and handle team-based access permissions.*

### 2. The Command Center
**The Main Dashboard**
![Dashboard](snapshots/feature_01.jpg)
*Once authenticated, users land on the Command Dashboard. This provides instant visibility into your database connections, connected RAG documents, and overall workspace health.*

**Multi-Project Workspaces**
![Workspaces](snapshots/feature_13.jpg)
*Create separate workspaces (e.g., HR, Sales, Marketing) mapped to entirely different databases, ensuring data doesn't cross-contaminate between departments.*

**Data Source Connectivity**
![Feature 18](snapshots/feature_18.jpg)
*Seamlessly connect multiple PostgreSQL, SQLite, or file-based data sources to a single workspace.*

### 3. Conversational Intelligence
**Chat Interface & SQL Transparency**
![Chat](snapshots/feature_02.jpg)
*The core experience. Users ask questions in plain English, and the AI translates them into secure SQL. Results are rendered as interactive tables with a collapsible 'Query Used' panel for total transparency.*

**Power-User Slash Commands (`\`)**
![Slash Commands](snapshots/feature_03.jpg)
*Type `/` to invoke system actions instantly without writing complex prompts: `/report` generates PDFs, `/schema` opens the database viewer, and `/clear` resets the context.*

**Precision Database Tags (`@`)**
![Table Tags](snapshots/feature_04.jpg)
*By typing `@` followed by a table name, users force the AI to strictly search within those specific database tables, guaranteeing 100% precision and eliminating hallucination.*

**Hands-Free Voice AI Agent**
![Voice Mic](snapshots/feature_09.jpg)
*For complete accessibility, users can speak their query. The AI will listen, execute the SQL, chart it, and speak the resulting insights back aloud.*

### 4. Advanced Analytics & Visualization
**Dynamic Chart Rendering**
![Analytics](snapshots/feature_08.jpg)
*Data isn't just tabular. AskBase dynamically renders beautiful Pie, Bar, Area, and Line charts based on the result set.*

**Visualizing Data Trends**
![Feature 6](snapshots/feature_06.jpg)
*Trend analysis is plotted instantly, allowing decision-makers to spot revenue spikes or inventory drops at a glance.*

**Pie Chart Deep-Dive**
![Pie Chart](snapshots/feature_24.jpg)
*Beautiful, accessible pie charts with interactive hover states for compositional data breakdown.*

**Advanced Charting Options**
![Feature 16](snapshots/feature_16.jpg)
*Deep-dive analytics tools and layout configurations let power users tweak axes, colors, and data points.*

**Dynamic Data Rendering**
![Feature 21](snapshots/feature_21.jpg)
*The platform automatically selects the best visualization type for the requested data without requiring manual chart configuration.*

**Data Grid & Table Views**
![Feature 10](snapshots/feature_10.jpg)
*Interactive tables with pagination, sorting, and inline viewing options for massive datasets.*

**Database Schema Inspector**
![Schema Inspector](snapshots/feature_07.jpg)
*Total transparency. Visualize every table, column, data type, and relationship mapped dynamically so you know exactly what data is available.*

### 5. Customization & Localization
**Global Analytics & Currency Localization**
![Currency Selection](snapshots/currency.jpg)
*For global teams, the interface allows instant localized currency switching, supporting 35 global currencies like the Indian Rupee (`₹`).*

**Regional Settings Integration**
![Feature 11](snapshots/feature_11.jpg)
*The selected currency and formatting preferences persist across all charts, tables, and exported reports.*

**User Preferences**
![Feature 26](snapshots/feature_26.jpg)
*Manage individual display settings, dark mode preferences, and API configurations.*

### 6. RAG, Reporting, and Export
**Corporate Knowledge Base (RAG)**
![Knowledge Base](snapshots/feature_05.jpg)
*Don't just query SQL. AskBase allows users to upload PDFs, CSVs, or JSONs. The system chunks and vector-indexes them, displaying a green "RAG Indexed" badge to guarantee secure answers.*

**Professional Executive Reports**
![Reports](snapshots/feature_12.jpg)
*Using the `\report` command, users can compile their entire analysis into a full-bleed, professional Executive PDF Document ready for boardroom presentations.*

**Automated AI Insights**
![Feature 14](snapshots/feature_14.jpg)
*Every report includes contextual LLM analysis highlighting anomalies, trends, and key performance indicators drawn from the charts.*

**Report Generation Settings**
![Feature 22](snapshots/feature_22.jpg)
*Configure PDF layouts, headers, footers, and brand colors to match corporate identity before exporting.*

**Universal Export (CSV, Excel, JSON)**
![Export](snapshots/feature_15.jpg) 
*Export any raw query result natively to CSV, Excel, or JSON for seamless integration with external tools like Tableau or Excel.*

### 7. Diagnostics & Tracking
**Executive Dashboard Builder**
![Feature 17](snapshots/feature_17.jpg)
*Drag-and-drop widget arrangement for custom KPI tracking on a unified screen.*

**Lineage Tracking**
![Feature 19](snapshots/feature_19.jpg)
*Data trust is paramount. Trace back any generated chart to the exact SQL query and source table it was derived from.*

**Query History & Favorites**
![Feature 20](snapshots/feature_20.jpg)
*Save complex, high-value queries for single-click re-execution later.*

**System Logs & Health**
![Feature 23](snapshots/feature_23.jpg)
*Monitor API latency, LLM token usage, and database connection status directly from the settings panel.*

**Data Processing Status**
![Feature 27](snapshots/feature_27.jpg)
*Live feedback and progress bars during long-running data indexing and RAG analysis tasks.*
