...
| Secure Account Creation | Team & Credential Management |
| :---: | :---: |
| ![Account Creation](snapshots/login_new.png) | ![Account Management](snapshots/account.jpg) |

### 🎛️ 2. The Command Center
Provides instant visibility into your database connections, connected RAG documents, and overall workspace health.

| The Main Dashboard | Multi-Project Workspaces |
| :---: | :---: |
| ![Dashboard](snapshots/feature_01.jpg) | ![Workspaces](snapshots/feature_13.jpg) |
...
| Precision Database Tags (`@`) | Hands-Free Voice AI Agent |
| :---: | :---: |
| ![Table Tags](snapshots/feature_04.jpg) | ![Voice Mic](snapshots/feature_09.jpg) |
...
| Dynamic Chart Rendering | Visualizing Data Trends |
| :---: | :---: |
| ![Analytics](snapshots/feature_08.jpg) | ![Feature 6](snapshots/feature_06.jpg) |

| Pie Chart Deep-Dive | Advanced Charting Options |
| :---: | :---: |
| ![Pie Chart](snapshots/feature_24.jpg) | ![Feature 16](snapshots/feature_16.jpg) |

| Dynamic Data Rendering | Data Grid & Table Views |
| :---: | :---: |
| ![Feature 21](snapshots/feature_21.jpg) | ![Feature 10](snapshots/feature_10.jpg) |

### 📁 5. Knowledge Base Manager & Schema Inspector
Upload datasets and documents or inspect structural metadata with the AI agent Autopilot.

| Corporate Knowledge Base (RAG) | Database Schema Inspector |
| :---: | :---: |
| ![Knowledge Base](snapshots/feature_05.jpg) | ![Schema Inspector](snapshots/feature_07.jpg) |

### 🌍 6. Customization & Localization
For global teams, the interface allows instant localized currency switching.

| Global Analytics & Currency Localization | Regional Settings Integration |
| :---: | :---: |
| ![Currency Selection](snapshots/currency.jpg) | ![Feature 11](snapshots/feature_11.jpg) |
...
### 📄 7. Reporting & Export
Using the `\report` command, users can compile their entire analysis into a professional Executive PDF Document.

| Professional Executive Reports | Automated AI Insights |
| :---: | :---: |
| ![Reports](snapshots/feature_12.jpg) | ![Feature 14](snapshots/feature_14.jpg) |

| Report Generation Settings | Universal Export (CSV, Excel, JSON) |
| :---: | :---: |
| ![Feature 22](snapshots/feature_22.jpg) | ![Export](snapshots/feature_15.jpg) |

### ⚙️ 8. Diagnostics & Tracking
Monitor API latency, LLM token usage, and database connection status.

| Executive Dashboard Builder | Lineage Tracking |
| :---: | :---: |
| ![Feature 17](snapshots/feature_17.jpg) | ![Feature 19](snapshots/feature_19.jpg) |

| Query History & Favorites | System Logs & Health |
| :---: | :---: |
| ![Feature 20](snapshots/feature_20.jpg) | ![Feature 23](snapshots/feature_23.jpg) |
