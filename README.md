...
│                 APPLICATION LAYER                   │
│                                                     │
│ Services • LangChain • Gemini AI • Business Logic   │
└─────────────────────────┬───────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────┐
│                     DATA LAYER                      │
...
![Account Auth](snapshots/account_auth.jpg)
> **At a glance:** Secure workspace and account access module.

**What this shows**
The authentication panel where users manage their profiles and securely log in.
...
![Currency Settings](snapshots/currency_dropdown.jpg)
> **At a glance:** Global currency formatting applied across all analytical dashboards.

**What this shows**
The configuration dropdown allowing users to select `INR (₹)` or other currencies for reporting.
...
![Table Tags](snapshots/feature_04.jpg)
> **At a glance:** Explicit table-targeting commands to eliminate AI hallucination.

**What this shows**
The `@` syntax used to force the LLM to search exclusively within targeted database tables.

**Key capabilities**
- `@sales`, `@customers`, `@orders` targeting
- Prevents out-of-scope querying
- Guaranteed 100% precision

![Slash Commands](snapshots/feature_03.jpg)
> **At a glance:** Power-user shortcuts for rapid reporting and context management.

**What this shows**
The `/` slash commands available in the chat for instant actions.

**Key capabilities**
- `/report` for executive PDF generation
- `/schema` for instant table inspection
- `/clear` for context wiping
...
![Upload](snapshots/feature_08.jpg)
> **At a glance:** The document ingestion interface.

**What this shows**
The modal used to upload new files into the AskBase secure storage bucket.
...
![Indexed Docs](snapshots/feature_07.jpg)
> **At a glance:** The indexed document list.

**What this shows**
Files that have been successfully embedded and indexed for Retrieval-Augmented Generation.

**Key capabilities**
- Index status tracking
- File vectorization
- Fast retrieval enablement
...
| *Visualizes comparative data metrics.* | *Visualizes data trends over time.* |

| Area Chart Mode | Pie Chart Mode |
| :---: | :---: |
| ![Area Chart](snapshots/feature_12.jpg) | ![Pie Chart](snapshots/feature_13.jpg) |
| *Visualizes volume and magnitude.* | *Visualizes proportional distribution.* |
...
![PDF Report](snapshots/feature_11.jpg)
> **At a glance:** The final PDF output generated by AskBase.

**What this shows**
A preview of the cleanly formatted Executive PDF report, embedding charts and insights.
...
![Export Buttons](snapshots/feature_14.jpg)
> **At a glance:** Native data export formats.

**What this shows**
The export controls allowing users to download raw datasets in various formats.

**Key capabilities**
- Instant CSV/JSON downloads
- Secure signed URL fetching
- Raw data access
...
![Voice Mic](snapshots/feature_19.jpg)
> **At a glance:** Active microphone listening state.

**What this shows**
The UI indicator showing that AskBase is actively listening to the user's spoken natural language query.
...
![Voice Speaking](snapshots/feature_21.jpg)
> **At a glance:** Active voice synthesis state.

**What this shows**
The AI agent speaking the results and insights aloud to the user.
...
![Projects](snapshots/feature_24.jpg)
> **At a glance:** Workspace and data source management.

**What this shows**
The Projects dashboard where users manage isolated tenant workspaces and connected databases.
...
![New Project](snapshots/feature_27.jpg)
> **At a glance:** New data source configuration.

**What this shows**
The configuration modal for binding a new PostgreSQL database to an AskBase project.
...
![Company Profile](snapshots/feature_26.jpg)
> **At a glance:** Global system settings and profile management.

**What this shows**
The overarching settings panel managing the company profile and system-wide configurations.
...
| **LangChain** | AI Agent orchestration and tool calling loops. |
| **Google Gemini API** | Natural language reasoning and SQL generation. |
...
- **Unit Tests:** 25 passing tests verified in `data-output/tests/unit/`.
...
- [x] LangChain / Gemini Agent Integration
- [x] Read-Only SQL Validation (SQLGlot)
- [x] PDF / CSV Export Engine
