...
### 🎬 [Watch ASKBASE AI in action — Live Demo Video](https://drive.google.com/file/d/1AmfNC6wFAVU-hVEMs3wKzBxUIe8djqbJ/view?usp=drivesdk)
...
Your gateway to enterprise data intelligence.

**Main Landing Page**
![Landing Page](snapshots/landing_page.png)

**Secure Account Creation**
![Account Creation](snapshots/login_new.png)
...
**Precision Database Tags (`@sales`, `@customers`)**
![Table Tags](snapshots/feature_04.jpg)

**Command Shortcuts (`/report`, `/schema`, `/help`)**
![Slash Commands](snapshots/feature_03.jpg)

### 📚 4. Knowledge Base
Upload and index your corporate documents for Retrieval-Augmented Generation.
...
### 🗄️ 5. Schema Inspector
Inspect database tables, foreign keys, and run automated anomaly diagnosis.

**Database Schema Inspector**
![Schema Inspector](snapshots/feature_09.jpg)

### 📊 6. Analytics & SQL
AskBase dynamically renders beautiful charts based on the SQL result set.

**Bar Chart Mode**
![Bar Chart](snapshots/feature_10.jpg)

**Line Chart Mode**
![Line Chart](snapshots/feature_06.jpg)

**Area Chart Mode**
![Area Chart](snapshots/feature_12.jpg)

**Pie Chart Mode**
![Pie Chart](snapshots/feature_13.jpg)
...
**Voice AI Microphone Active**
![Voice Mic](snapshots/feature_19.jpg)

**Voice Agent Speaking Aloud**
![Voice Speaking](snapshots/feature_21.jpg)

### 📁 10. Projects
Manage your data sources and project workspaces.

**Projects & Data Sources**
![Projects](snapshots/feature_24.jpg)

**New Data Project Configuration**
![New Project](snapshots/feature_27.jpg)

### ⚙️ 11. System Health & Settings
Ensure strict tenant isolation and configure global settings.
